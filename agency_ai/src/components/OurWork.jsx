...
const OurWork = () => {
    ...
    const workData = [
       {
        ...
        description :"We turn bold ideas into digital solutions that connect and engage...",
  ...
  return (
    <div id="our-work" className="flex flex-col items-center  gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white">
      <Title title="our latest work" desc="from strategy to execution , we craft digital solutions that move your business foorward"/>
